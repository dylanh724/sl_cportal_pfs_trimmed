...
TransMenu.shadowColor = "#00bce4";                        // color of shadow (transparency is set in CSS)
TransMenu.shadowPng = "themes/nervecenter/javascript/img/grey-40.png";               // a PNG graphic to serve as the shadow for mac IE5
TransMenu.backgroundColor = "#00bde4";                   // color of the background (transparency set in CSS)
